...
function populateTemplateWithDigits(template, position, digits) {
  for (var _iterator2 = _createForOfIteratorHelperLoose4(digits.split("")), _step2; !(_step2 = _iterator2()).done; ) {
...
var PatternParser = function() {
  function PatternParser2() {
    _classCallCheck3(this, PatternParser2);
  }
  return _createClass3(PatternParser2, [{
    key: "parse",
...
var PatternMatcher = function() {
  function PatternMatcher2(pattern) {
    _classCallCheck4(this, PatternMatcher2);
    this.matchTree = new PatternParser().parse(pattern);
  }
  return _createClass4(PatternMatcher2, [{
    key: "match",
...
var AsYouTypeFormatter = function() {
  function AsYouTypeFormatter2(_ref) {
    ...
    _classCallCheck5(this, AsYouTypeFormatter2);
    this.metadata = metadata;
    this.resetFormat();
  }
  return _createClass5(AsYouTypeFormatter2, [{
    key: "resetFormat",
...
function getNumberType(input, options, metadataJson) {
  ...
  for (var _iterator = _createForOfIteratorHelperLoose8(NON_FIXED_LINE_PHONE_TYPES), _step; !(_step = _iterator()).done; ) {
...
function getCountryByNationalNumber(nationalNumber, countries, metadataJson) {
  var metadata = new Metadata(metadataJson);
  for (var _iterator = _createForOfIteratorHelperLoose9(countries), _step; !(_step = _iterator()).done; ) {
...
function formatNumber2(input, format, options, metadataJson) {
  ...
  switch (format) {
    case "NATIONAL":
      ...
      number = formatNationalNumber2(nationalNumber, input.carrierCode, "NATIONAL", metadata, options);
      return addExtension(number, input.ext, metadata, options.formatExtension);
    case "INTERNATIONAL":
      if (!nationalNumber) {
        return "+".concat(countryCallingCode);
      }
      number = formatNationalNumber2(nationalNumber, null, "INTERNATIONAL", metadata, options);
...
function formatNationalNumber2(number, carrierCode, formatAs, metadata, options) {
...
function formatIDD(nationalNumber, carrierCode, countryCallingCode, fromCountry, metadata) {
  ...
  if (fromCountryCallingCode === countryCallingCode) {
    var formattedNumber = formatNationalNumber2(nationalNumber, carrierCode, "NATIONAL", metadata);
  ...
  if (iddPrefix) {
    return "".concat(iddPrefix, " ").concat(countryCallingCode, " ").concat(formatNationalNumber2(nationalNumber, null, "INTERNATIONAL", metadata));
  }
}
function merge() {
  var i = 1;
...
var PhoneNumber = function() {
  function PhoneNumber2(countryOrCountryCallingCode, nationalNumber, metadata) {
    _classCallCheck6(this, PhoneNumber2);
  ...
  return _createClass6(PhoneNumber2, [{
    key: "setExt",
...
var AsYouType = function() {
  ...
  return _createClass9(AsYouType2, [{
...
function _slicedToArray4(r, e) {
  return _arrayWithHoles4(r) || _iterableToArrayLimit4(r, e) || _unsupportedIterableToArray12(r, e) || _nonIterableRest4();
}
...
function normalizeArguments(args) {
  var _Array$prototype$slic = Array.prototype.slice.call(args), _Array$prototype$slic2 = _slicedToArray4(_Array$prototype$slic, 4), arg_1 = _Array$prototype$slic2[0], arg_2 = _Array$prototype$slic2[1], arg_3 = _Array$prototype$slic2[2], arg_4 = _Array$prototype$slic2[3];
  var text;
  var options;
  var metadata;
...
var LRUCache = function() {
  ...
  return _createClass10(LRUCache2, [{
    key: "put",
...
var RegExpCache = function() {
  ...
  return _createClass11(RegExpCache2, [{
...
function checkNumberGroupingIsValid(number, candidate, metadata, checkGroups, regExpCache) {
  ...
  if (alternateFormats) {
    for (var _iterator = _createForOfIteratorHelperLoose10(alternateFormats.numberFormats()), _step; !(_step = _iterator()).done; ) {
...
var PhoneNumberMatcher = function() {
  ...
  return _createClass12(PhoneNumberMatcher2, [{
    key: "find",
    ...
    value: function extractInnerMatch(substring, offset, text) {
      for (var _iterator = _createForOfIteratorHelperLoose11(this.INNER_MATCHES), _step; !(_step = _iterator()).done; ) {
...
//# sourceMappingURL=chunk-FJJ6Y43I.js.map
